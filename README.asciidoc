== javabeans
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The javabeans addon enables blah blah...)
